...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        // ✅ Only allow numbers in Salary field
        tsalary.addKeyListener(new KeyAdapter() {
            @Override
        ...
        // ✅ Only allow numbers in Aadhar field
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            // ✅ Email format validation — must contain "@gmail.com"
            if (!email.toLowerCase().endsWith("@gmail.com")) {
                JOptionPane.showMessageDialog(null, "The email is invalid email. try again later.");
                return;
            }
